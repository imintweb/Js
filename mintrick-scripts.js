...
function shortCodeIfy(e, t, a) {
  for (var o = e.split("$"), r = /[^{\}]+(?=})/g, i = 0; i < o.length; i++) {
    var s = o[i].split("=");
    if (s[0].trim() == t)
      return null != (a = s[1]).match(r) && String(a.match(r)).trim();
  }
  return !1;
}
function msgError() {
...
function getPostTag(e, t, a) {
  return e[t].category
    ? '<span class="entry-category">' + e[t].category[0].term + "</span>"
    : "";
}
function getPostAuthor(e, t, a, o) {
  return (
    (o =
      "" != exportify.postAuthorLabel
        ? '<span class="sp">' + exportify.postAuthorLabel + "</span>"
        : ""),
    exportify.postAuthor
...
function getPostDate(e, t, a, o, r, i) {
  ...
  var s = e[t].published.$t,
    ...
    c = s.substring(8, 10),
    d = dateFormat
      .replace("{m}", monthNames[parseInt(l, 10) - 1])
      .replace("{d}", c)
      .replace("{y}", n);
  return (
    (i =
      exportify.postAuthor && "" != exportify.postDateLabel
        ? '<span class="sp">' + exportify.postDateLabel + "</span>"
        : ""),
    [
      1 == exportify.postDate
        ...
        : "",
      1 == exportify.postDate
        ? '<span class="entry-time mi"><time class="published" datetime="' +
          s +
          '">' +
          d +
          "</time></span>"
...
function getPostMeta(e, t, a, o, r) {
  ...
  return [
    1 == exportify.postAuthor || 1 == exportify.postDate
      ? '<div class="entry-meta">' + e + t[0] + "</div>"
      : "",
    1 == exportify.postDate
      ? '<div class="entry-meta">' + t[1] + i + "</div>"
      : "",
  ];
}
function getFirstImage(e, t) {
  var a = $("<div>").html(e).find("img:first").attr("src"),
    ...
    n = a.substring(o);
  return (
    (s.match(/\/s[0-9]+/g) || s.match(/\/w[0-9]+/g) || "/d" == s) &&
      (s = "/w72-h72-p-k-no-nu"),
    i + s + n
  );
}
function getPostImage(e, t, a, o) {
  ...
  return (
    ...
    r.indexOf(r.match(/<iframe(?:.+)?src=(?:.+)?(?:www.youtube.com)/g)) > -1
      ? r.indexOf("<img") > -1
        ? r.indexOf(r.match(/<iframe(?:.+)?src=(?:.+)?(?:www.youtube.com)/g)) <
          r.indexOf("<img")
          ? a
...
function getPostSummary(e, t, a, o, r, i) {
  return e[t].content
    ? '<span class="entry-excerpt excerpt">' +
        $("<div>").html(e[t].content.$t).text().trim().substr(0, a) +
        "…</span>"
    : "";
}
function getPostComments(e, t, a, o) {
  var r = e[t].author[0].name.$t,
    i = e[t].author[0].gd$image.src
      .replace("/s113", "/s72-c")
      .replace("/s220", "/s72-c"),
    s = e[t].title.$t;
  return (
    (i.match("//img1.blogblog.com/img/blank.gif") ||
      i.match("//img1.blogblog.com/img/b16-rounded.gif")) &&
      (i =
        "//4.bp.blogspot.com/-oSjP8F09qxo/Wy1J9dp7b0I/AAAAAAAACF0/ggcRfLCFQ9s2SSaeL9BFSE2wyTYzQaTyQCK4BGAYYCw/w72-h72-p-k-no-nu/avatar.jpg"),
          ...
          if (null != c) {
            ...
            for (l = c; d < l.length; d++) {
              ...
              switch (t) {
                case "msimple":
                  v +=
                    '<div class="mega-item post"><a title="' +
                    n +
                    '" class="entry-image-wrap  ' +
                    u +
                    '" href="' +
                    s +
                    '"><svg class="entry-thumb" viewBox="0 0 16 9" data-image="' +
                    p +
                ...
                case "featured":
                  v +=
                    '<div class="featured-item cs item-' +
                    d +
                    '"><a class="featured-inner" href="' +
                    s +
                    '" title="' +
                    n +
                    ...
                    p +
                    '"></span></span><div class="entry-header entry-info">' +
                    m +
                ...
                case "grid":
                  v +=
                    ...
                    '"><svg class="entry-thumb" viewBox="0 0 16 9" data-image="' +
                    p +
                    '"/></a><div class="entry-header"><h2 class="entry-title"><a title="' +
                    n +
                    '" href="' +
                    s +
                    '">' +
                ...
                case "video":
                  v +=
                    ...
                    '"><a title="' +
                    n +
                    '" class="entry-image-wrap  is-video" href="' +
                    s +
                    '"><svg class="entry-thumb" viewBox="0 0 16 9" data-image="' +
                    p +
                    '"/></a><div class="entry-header"><h2 class="entry-title"><a title="' +
                ...
                case "default":
                  v +=
                    '<div class="default-item ds item-' +
                    d +
                    '"><a title="' +
                    n +
                    '" class="entry-image-wrap  ' +
                ...
                case "related":
                  ...
                  v +=
                    ...
                    '" href="' +
                    s +
                    '"><svg class="entry-thumb" width="100" height="62.5" viewBox="0 0 16 9" width="" data-image="' +
                    p +
                    '"/></a><div class="entry-header"><h2 class="entry-title"><a href="' +
                    s +
                    '" title="' +
...
function ajaxBlock(e, t, a, o, r, i, s) {
  if (r.match("getcontent")) {
    if ("block" == t || "grid" == t || "list" == t || "video" == t)
      return (
        0 != o &&
          ((i = "recent" == o ? "/search" : "/search/label/" + o),
          (s = "" != viewAllText.trim() ? viewAllText : exportify.viewAll),
          e
            .parent()
            .find(".widget-title")
            .append('<a href="' + i + '" class="wt-l">' + s + "</a>")),
        getAjax(e, t, a, o)
      );
    e.html(msgError());
  }
...
function ajaxWidget(e, t, a, o, r) {
  if (r.match("getcontent")) {
    if ("default" == t || "mini" == t || "comments" == t)
...
function beautiAvatar(e) {
  $(e).attr("src", function (e, t) {
    return (t = (t = t.replace(
      ...
      "//4.bp.blogspot.com/-oSjP8F09qxo/Wy1J9dp7b0I/AAAAAAAACF0/ggcRfLCFQ9s2SSaeL9BFSE2wyTYzQaTyQCK4BGAYYCw/s39/avatar.jpg"
    )).replace(
...
function fixedSidebarIfy(e) {
  $(e).each(function (e) {
    (fixedSidebar = "undefined" == typeof fixedSidebar || fixedSidebar),
      1 == fixedSidebar &&
        ((e = 1 == fixedMenu ? 89 : 30),
...
(window.location.hash = ""),
  ...
  (viewAllText =
    "undefined" != typeof viewAllText ? viewAllText : exportify.viewAll),
  ...
  $(".post-body b").each(function () {
    ...
    t.match("{contactform}") &&
      ...
      t.match("{leftsidebar}") && ($("body").addClass("is-left"), e.remove()),
      t.match("{rightsidebar}") &&
        ($("body").addClass("is-right").removeClass("is-left"), e.remove()),
      t.match("{fullwidth}") && ($("body").addClass("no-sidebar"), e.remove());
  }),
  ...
  $(".post-body pre").each(function () {
    ...
    e.is("[lang]") &&
      e.replaceWith(
        '<pre class="language-' + a + '"><code>' + t + "</code></pre>"
      );
  }),
  $(".entry-share-links .window-ify,.post-share .window-ify").on(
    "click",
    function () {
      var e = $(this),
        t = e.data("url"),
  ...
  $("#ticker .HTML .widget-content").each(function (e, t) {
    ...
    null != r &&
      ...
      o
        .on("load resize scroll", function r() {
          o.scrollTop() + o.height() >= a.offset().top &&
    ...
    null != o &&
      ...
      a
        .on("load resize scroll", function o() {
          a.scrollTop() + a.height() >= t.offset().top &&
  ...
  $(".content-section .HTML .widget-content").each(function (e, t, a) {
    ...
    null != i &&
      ...
      r
        .on("load resize scroll", function i() {
          r.scrollTop() + r.height() >= o.offset().top &&
            (r.off("load resize scroll", i), ajaxBlock(o, a, e, t, mtc));
        })
        .trigger("scroll"));
  }),
    ...
    null != s &&
      ...
      i
        .on("load resize scroll", function s() {
          i.scrollTop() + i.height() >= r.offset().top &&
            (i.off("load resize scroll", s), ajaxWidget(r, o, t, a, e));
        })
        .trigger("scroll"));
  }),
    ...
    if (null != o) {
      ...
      $("#related-wrap").each(function (e, t) {
        var o = $(this),
          ...
          n = r();
        (e = 0 != n[1] ? n[1] : 3),
          0 != n[0] && o.find(".related-title .title > span").text(n[0]),
          (t = o.find(".related-tag").data("label")),
          i
            .on("load resize scroll", function o() {
              i.scrollTop() + i.height() >= s.offset().top &&
        ...
        e
          ...
          .html(
            '<div class="fb-comments" data-width="100%" data-href="' +
              ...
              '" order_by="time" data-numposts="5" data-lazy="true"></div>'
          ),
          e.show();
        break;
      case "hide":
  ...
  $(function () {
    $(
      ".entry-image-wrap .entry-thumb,.author-avatar-wrap .author-avatar,#particle, .ratio-16-10"
    ).lazyify(),
      $("#vtrick-pro-mobile-menu").each(function () {
        ...
        t.attr("id", "main-mobile-nav"),
          ...
          t.find(".mega-menu > a").each(function (e, t) {
            ...
            null != o &&
              ((t =
                "recent" == (e = shortCodeIfy(o.trim(), "label"))
                  ? "/search"
                  : "/search/label/" + e),
              a.attr("href", t));
          }),
          t.appendTo(e),
          $(".mobile-menu-toggle, .hide-vtrick-pro-mobile-menu, .overlay").on(
            "click",
            function () {
              $("body").toggleClass("nav-active");
            }
          ),
          $(".vtrick-pro-mobile-menu .has-sub").append(
            '<div class="submenu-toggle"/>'
          ),
          $(".vtrick-pro-mobile-menu .mega-menu")
            .find(".submenu-toggle")
            .remove(),
          $(".vtrick-pro-mobile-menu ul li .submenu-toggle").on(
            "click",
            function (e) {
      ...
      $("a#vt" + "ri" + "ck").each(function () {
        ...
        e
          ...
          e.parent().attr("style", t).parent().attr("style", t);
      }),
      setInterval(function () {
        var th = "www",
          ...
          o = "com/";
        $("a#" + "vtr" + "ick").length ||
          (window.location.href = dc + mm + th + "." + an + g + ch + "." + o),
          $("a#vt" + "ric" + "k:visible").length ||
            (window.location.href = dc + mm + th + "." + an + g + ch + "." + o);
      }, 1e3),
      $(".header-inner").each(function () {
        ...
        if (1 == fixedMenu && e.length > 0) {
          ...
          $(window).scroll(function () {
            ...
            o > r
              ? e.addClass("is-fixed")
              : (o < a || o <= 1) && e.removeClass("is-fixed"),
      ...
      $("#vtrick-pro-load-more-link").each(function () {
        ...
        e && $("#vtrick-pro-load-more-link").show(),
          $("#vtrick-pro-load-more-link").on("click", function (t) {
              ...
              $.ajax({
                ...
                success: function (t) {
                  ...
                  a.find(".index-post").addClass("post-animated post-fadeInUp"),
                    ...
                    (e = $(t).find("#vtrick-pro-load-more-link").data("load"))
                ...
                complete: function () {
                  $("#blog-pager .loading").hide(),
                    $(
                      ".index-post .entry-image-wrap .entry-thumb,.author-avatar-wrap .author-avatar"
                    ).lazyify(),
      ...
      $("#vtrick-pro-cookie-ify").each(function () {
        ...
        null != t &&
          ...
          0 != ok && e.find("#vtrick-pro-cookie-ify-accept").text(ok),
          0 != days ? (days = Number(days)) : (days = 7)),
          e.length > 0 &&
            ("1" !== $.cookie("vtrick_pro_cookie_ify_consent") &&
              (e.css("display", "block"),
              $(window).on("load", function () {
            ...
            $("#vtrick-pro-cookie-ify-accept")
              ...
              .on("click", function (t) {
                t.preventDefault(),
                  t.stopPropagation(),
                  $.cookie("vtrick_pro_cookie_ify_consent", "1", {
                    expires: days,
                    path: "/",
                  }),
      ...
      $("#back-top").each(function () {
        ...
        $(window).on("scroll", function () {
          ...
          $(this).scrollTop() >= 100
            ? (e.fadeIn(170),
              a.hasClass("has-backtop") ||
                (a.animate({ bottom: "+=46px" }, 170),
                a.addClass("has-backtop")))
            : (e.fadeOut(170),
              a.hasClass("has-backtop") &&
                (a.animate({ bottom: "-=46px" }, 170),
                a.removeClass("has-backtop"))),
            e.hasClass("on-footer") &&
              !a.hasClass("get-footer") &&
              (a.animate({ bottom: "-=46px" }, 170), a.addClass("get-footer")),
            !e.hasClass("on-footer") &&
              a.hasClass("get-footer") &&
              (a.animate({ bottom: "+=46px" }, 170),
              a.removeClass("get-footer")),
            $(this).scrollTop() + t >= $("#footer-wrapper").offset().top + 36
